...
def apply_single_rotary_pos_emb(inputs, cos, sin, position_ids, unsqueeze_dim=1):
    # print("before unsqueeze: cos shape:", cos.shape, " sin shape:", sin.shape, " position_ids shape:", position_ids.shape)
...
class Qwen2ModifiedAttention(Qwen2Attention):
    def forward(
        ...
        # wk: debug
        # print("full_position_ids shape:", full_position_ids.shape)
